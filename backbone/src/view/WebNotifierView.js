...
module.exports = Backbone.View.extend({
    ...
    showWebNotif: function() {
        ...
        let title = 'Du bist ein bisschen dran';
    ...
    check: function() {
        if (!('Notification' in window)) {
            ...
            if (Notification.permission === 'denied') {
                ...
                this.notifPossible();
                if (store.enabled) {
                    let storePath = 'user.settings.webnotification.dran';
                    let notifyIntention = store.get(storePath) || false;
        ...
        this.$('#notif').change(function(e) {
            let wantNotification = e.currentTarget.checked;
            if (store.enabled) {
                let storePath = 'user.settings.webnotification.dran';
