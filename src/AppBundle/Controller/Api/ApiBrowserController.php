...
class ApiBrowserController extends Controller
{
    ...
    public function apiBrowserAction()
    {
        $urls = array(
            ...
            "/api/user/Botrix/dran.json" => "Legacy API, deprecated",
            "/api/blockers" => "APIv2",
            "/api/user/blockerlist.json" => "Legacy API, deprecated",
            "/api/users/1/blockers" => "APIv2",
            "/api/user/1/blocker.json" => "Legacy API, deprecated",
            ...
            "/api/games/44773/info" => "Legacy API, deprecated",
            "/api/games/44773/details" => "Legacy API, deprecated",
        );
